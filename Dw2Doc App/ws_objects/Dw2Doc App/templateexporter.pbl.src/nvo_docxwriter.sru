$PBExportHeader$nvo_docxwriter.sru
forward
global type nvo_docxwriter from dotnetobject
end type
end forward

global type nvo_docxwriter from dotnetobject
end type
global nvo_docxwriter nvo_docxwriter
...
public function long of_writedocx(string as_path,string as_columns[],string as_rows[],ref string as_error)
...
ll_result = This.writedocx(as_path,as_columns,as_rows,ref as_error)
Return ll_result
end function
...
on nvo_docxwriter.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_docxwriter.destroy
