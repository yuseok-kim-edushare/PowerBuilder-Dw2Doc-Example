...
{
    [TestClass]
    public class XlsxExportIntegrationTests
    {
        private const string TestOutputDir = "TestOutput";
        private readonly string _testFilePath;

        public XlsxExportIntegrationTests()
        {
            ...
            _testFilePath = Path.Combine(TestOutputDir, "integration_test.xlsx");
        ...
        [TestMethod]
        public void ExportGrid_CreatesValidXlsxFile()
        {
        ...
        public void ExportComplexGrid_CreatesCorrectXlsxStructure()
        {
            ...
            // Verify more complex file structure
